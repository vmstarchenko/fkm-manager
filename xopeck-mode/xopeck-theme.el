...
(let* ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(magit-diff-file-header             ,dummy)
   `(magit-diff-hunk-header             ,dummy)
   ...
   `(magit-diff-file-heading           ,dummy)
   `(magit-diff-file-heading-highlight ,dummy)
   ...
   `(magit-section-heading             ,dummy)
   `(magit-section-heading-selection   ,dummy)
   `(magit-section-highlight           ,dummy)
